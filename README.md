...
- <code>ct2foam --input h2o2.yaml --output test_output --Tmid 1000.0 --plot </code>
...
-  <code> ctmix2foam --input h2o2.yaml --output test_output --name air --mixture "O2:1,AR:4" --Tmid 1000.0 --plot  </code>
...
- How-to:
    - Generate pyjac C-files (requires pyjac):
        - <code>python -m pyjac --lang c --last_species N2 --input my_mechanism.yaml</code>
    - Compile + generate *.foam files under the same directory where pyjac output files are located.
        - <code>pyjac2foam -m my_mechanism.yaml -i pyjac/path -c</code>
